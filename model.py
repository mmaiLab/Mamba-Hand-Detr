...
class A2J_model(nn.Module):
    def __init__(self, backbone_net, position_embedding, transformer, num_classes, num_queries, num_feature_levels,
        ...
        if with_box_refine:
            ...
            # self.transformer.decoder.bbox_embed = MLP(hidden_dim, hidden_dim, 3, 3)
            # self.transformer.decoder.bbox_embed = _get_clones(self.transformer.decoder.bbox_embed, num_pred)
